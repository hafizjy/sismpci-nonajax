        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="#lihatNA" data-toggle="tab">Lihat Jenis Nilai</a></li>
            </ul>
            <div class="tab-content">
              ...
              <form class="form-horizontal formmapel">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <td><button type="submit" class="btn btn-danger" href="#lihatNA" data-toggle="tab">Submit</button></td><td> <button class="btn btn-danger" href="#lihatNA" data-toggle="tab">Back</button></td>
                    </div>
                  </div>
                </div>
                </form>
